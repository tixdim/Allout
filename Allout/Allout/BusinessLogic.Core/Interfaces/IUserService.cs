...
namespace Allout.BusinessLogic.Core.Interfaces
{
    public interface IUserService
    {
        ...
        Task<List<AuctionBlo>> AllAuctionsWhichCreatUser(int userId, int count, int skipCount); // сделать все аукционы, которые создал юзер
        Task<List<AuctionBlo>> AllAuctionsWhichMemberUser(int userId, int count, int skipCount); // сделать все аукционы, в которых учавствовал юзер
